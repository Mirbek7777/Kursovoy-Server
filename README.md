Данная программа-сервер предназначенна для подключения клиентов к чату и отправки сообщения от отправившего сообщение клиента к всем другим присоединенным к серверу клиентам.
